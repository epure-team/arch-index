# qa-scope — functor-path-census

**Status: VALIDATED**

Run exact gates from full plan, all standalone checks and semantic replay. Validate fixture outcomes, negative manifests, no false ownership claims, exact410 hash/partition totals. No TUI.
