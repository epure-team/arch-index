...
3. **SHIPPED — ocaml-cfa-propagation**: PR112 merged2026-09-16T17:21:21Z, main0eb5887. Bounded same-CMT arguments/returns/captures/recursion/partial applications; shared direct/root/local let admission; partial-LSP setup classification. Roster review round3 GO, QA345/345 plus CHECK1/2/3 GO, exact-head CI35126214642 green before guarded rebase merge. Pinned410: +72Irmin/+270protocol,342 gains,0loss/newMUST. Not whole-program0CFA.
4. **NEXT — ocaml-functor-targets**: concrete actual member correspondence using functor-bindings, explicit supported application identities, and independently compiled same-source variant handling deferred from stage 1 by explicit user approval. Branch `feat/ocaml-functor-correspondence` carries the Stage3 delivery receipt only; product work has not started.
