# QA scope — tezos-residual-targets
...
Validate all13 AC: exact body endpoints; one-hop/mask/refusal shapes; supplied
arity and residual count; preserved point-free/CFG/config metadata; storage and
flat attribution; fresh frozen replay; candidate witness/multiset and malformed
input controls; no MUST/loss; body table/unqualified behavior unchanged; no keep
without positive gain/full delivery; exact smoke golden. Use actual QA state
and convergence checker. Conditional code-intel/claims/TUI/web absent/N/A must
be recorded as skips, not approvals. Raw complete test logs retained ignored.
