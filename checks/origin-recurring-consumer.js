...
async function authentic() {
  ...
  try {
    ...
    assert.deepEqual(production.run.coverage.current.totals,{modules:25,functions:989,calls:6275,origins:564});
    ...
    assert.deepEqual(allowed,['collect_calls_from_expr.<fun:1545:21>.<fun:1556:36> | lib/arch_index/arch_index_cmt.ml:1559 | assert | Assert_failure | x1']);
