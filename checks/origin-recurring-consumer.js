...
async function authentic() {
  ...
  try {
    ...
    assert.deepEqual(production.run.coverage.current.totals,{modules:27,functions:1200,calls:7356,origins:641});
    ...
    assert.deepEqual(allowed,['collect_calls_from_expr_with_open_bodies.<fun:1834:21>.<fun:1845:36> | lib/arch_index/arch_index_cmt.ml:1848 | assert | Assert_failure | x1']);
