...
- `improvement/2026-09-16-cfa-propagation/self-2x2-2823706-1789573964636/report.json`
- `improvement/2026-09-16-cfa-propagation/self-2x2-2838338-1789573984038/report.json`

| Cell | Engine | Corpus | Modules | Functions | Calls | Origins |
|---|---|---|---:|---:|---:|---:|
| A | base | base | 27 | 1082 | 6808 | 603 |
| B | Stage 3 | base | 27 | 1082 | 6810 | 603 |
| C | base | Stage 3 | 27 | 1143 | 7061 | 614 |
| D | Stage 3 | Stage 3 | 27 | 1143 | 7066 | 614 |
...
corpus. Source growth accounts for 61 functions and eleven origins; the current
...
The complete `Texp_let` family correction adds the shared computed-form
classifier to the current source corpus: one function and five calls, with no
new origin. The two fresh runs above agree exactly on totals and digests.
...
CMTs), the exact self-index smoke passes at `27/1143/7066`, and the authentic
origin consumer is held at `27/1143/7066/614` with zero reference delta and its
